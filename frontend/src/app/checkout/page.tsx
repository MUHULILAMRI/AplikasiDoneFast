...
export default function CheckoutPage() {
  ...
  const orderTotal = 150000; // This would come from the order context
      ...
      <main>
        ...
        <div className="min-h-screen pt-24 pb-16 flex items-center justify-center">
          ...
          >
            ...
            <p className="text-muted mb-2">Order ID: <span className="text-foreground font-mono">DF-XYZ123</span></p>
              ...
              <div className="glass rounded-2xl p-6 sticky top-28">
                ...
                <div className="space-y-3 mb-6">
                  <div className="p-3 bg-surface-2 rounded-xl border border-border">
                    <p className="text-sm font-medium">Makalah Ekonomi Makro</p>
                    <p className="text-xs text-muted mt-1">Pembuatan Makalah & Essay</p>
                  </div>
